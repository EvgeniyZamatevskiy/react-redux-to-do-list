...
test("tasks should be added for todolist", () => {
  ...
  const action = getTasks.fulfilled({
    ...
    tasks: startState.tasks["todolistId1"]
...
test("correct taskItem should be added to correct array", () => {
...
test("correct taskItem should be deleted from correct array", () => {
...
test("taskItem object should be nulled", () => {
